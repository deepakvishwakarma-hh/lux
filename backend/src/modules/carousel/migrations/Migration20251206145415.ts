...
export class Migration20251206145415 extends Migration {
    ...
    override async up(): Promise<void> {
        ...
        this.addSql(`CREATE INDEX IF NOT EXISTS "IDX_carousel_order" ON "carousel" ("order") WHERE deleted_at IS NULL;`);
    }
