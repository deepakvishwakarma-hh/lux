    ...
    <div className="flex flex-col gap-3 sm:gap-4 mb-6 sm:mb-8 pb-4 border-b border-gray-200">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-3 w-full">
        ...
        <select
          ...
          className="w-full sm:w-auto px-3 sm:px-4 py-2.5 sm:py-2 text-xs sm:text-sm border border-gray-300 rounded-md bg-white focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent cursor-pointer"
        >
